/**
 * VENDORED from server/src/bots/policies/hard.ts @ 9009d5262afd983392c565e1d5e51bbdf31da92b
 ...
 *    read-only (strict majority of owned port ports around a sea zone);
 ...
 *    Granary), SEA RESUPPLY (a port city cannot starve unless EVERY
...
import { neighborsOf } from "../../engine/index.js";
import {
  CONQUEST_PRESTIGE,
  GREAT_WORK_COSTS,
  MERC_COMPANIES,
...
import { TACTIC_CARD_BY_ID } from "../../engine/index.js";
 ...
 * §8.2.3 starvation clock with GRANARY and SEA-RESUPPLY awareness (a port
...
function scoreNavalMove(hc: HardCtx, action: MoveA): number {
  ...
  // Siege support: closing a supply zone of a port city I am besieging
...
/** BFS shortest sea-zone path between two port provinces (≤ 5 zones). */
